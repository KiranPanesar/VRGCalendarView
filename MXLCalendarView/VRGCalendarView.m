...
-(void)showNextMonth {
    ...
    if ([delegate respondsToSelector:@selector(calendarView:switchedToMonth:targetHeight: animated:)]) [delegate calendarView:self switchedToMonth:[currentMonth month] year:[currentMonth year] numOfDays:[currentMonth numDaysInMonth] targetHeight:self.calendarHeight animated:YES];
...
-(void)showPreviousMonth {
    ...
    //Prepare next screen
    self.currentMonth = [currentMonth offsetMonth:-1];
    if ([delegate respondsToSelector:@selector(calendarView:switchedToMonth:year:numOfDays:targetHeight:animated:)]) [delegate calendarView:self switchedToMonth:[currentMonth month] year:[currentMonth year] numOfDays:[currentMonth numDaysInMonth] targetHeight:self.calendarHeight animated:YES];
...
{       
    ...
    if (touchPoint.y > kVRGCalendarViewTopBarHeight) {
        ...
        CGFloat yLocation = touchPoint.y-kVRGCalendarViewTopBarHeight;
